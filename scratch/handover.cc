...
TriggerHO (uint32_t radius, double speed){
    return (9*radius)/(2*sqrt(3)*speed);
}
...
main (int argc, char *argv[])
{
  ...
  uint16_t numberOfUesEpc1 = 4;
  uint16_t numberOfUesEpc2 = 4;
  uint32_t radius = 50;
...
//.................
 ...
 //......
  ...
  lteVoiceUeContainerHO.Create(2);
...
//..
  ...
  NS_LOG_UNCOND("Handover(s) completed but downlink traffic is lost due to the lack of a DMM solution.");
